...
def download_file(filename, target_dir, source):
    gsutil = "gsutil" if platform.system() != "Windows" else "gsutil.cmd"
    downloadCmd = [
        gsutil,
        "cp",
        "-n",
...
if __name__ == "__main__":
    ...
    #data_list = "script/waymo/waymo_splits/segment_list_train.txt"
    #data_cloud_url = "gs://waymo_open_dataset_v_1_4_1/individual_files/training"
    data_list = "script/waymo/waymo_splits/segment_list_val.txt"
    data_cloud_url = "gs://waymo_open_dataset_v_1_4_1/individual_files/validation"

    args = parser.parse_args()
    os.makedirs(args.target_dir, exist_ok=True)
    total_list = open(data_list, "r").readlines()
    ...
    download_files(file_names, args.target_dir, data_cloud_url)
